...
<div class="pull-right">
    ...
    <ul class="header-dropdown-list hidden-xs">
        <li>
            ...
            ?>
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="img/blank.gif" class="flag <?= $defaultLang[$lang]['flag']?>" alt="<?= $defaultLang[$lang]['name']?>"> <span> <?= $defaultLang[$lang]['name']?> </span> <i class="fa fa-angle-down"></i> </a>
            <ul class="dropdown-menu pull-right">
                <?php
                ...
                ?>
                    <li>
                        <a href="<?= $this->Url->build(['plugin' => null, 'controller' => 'pages', 'action' => 'change_language', $value['key']])?>"><img src="img/blank.gif" class="flag <?= $value['flag']?>" alt="<?= $value['name']?>"> <?= $value['name']?> </a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </li>
