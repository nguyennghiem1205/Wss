                    ...
                    <fieldset>
                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                            ...
                            <tr>
                                ...
                                <td style="width:65%"><?= $this->Core->image('Ceo/'.$ceoInfo->image, 100, 100, [], false) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Name') ?></td>
                                <td style="width:65%"><?= h($ceoInfo['name']) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Position') ?></td>
                                <td style="width:65%"><?= h($ceoInfo['position_'.__('lang')]) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('comment') ?></td>
                                <td style="width:65%"><?= ($ceoInfo['comment_'.__('lang')]) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Active') ?></td>
                                <td style="width:65%"><?= $this->Core->active($ceoInfo, 'active')?></td>
                            </tr>
                            </tbody>
                        </table>
                    </fieldset>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $this->Html->link(__('edit'), ['action' => 'add', $ceoInfo->id], ['class' => 'btn btn-primary']) ?>
                            </div>
                        </div>
                    </div>
                </div>
