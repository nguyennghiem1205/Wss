                    ...
                    <fieldset>
                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                            ...
                            <tr>
                                ...
                                <td style="width:65%"><?= $this->Core->image('Categories/'.$category->image, 100, 100, [], false) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Title') ?></td>
                                <td style="width:65%"><?= h($category['title_'.__('lang')]) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Description') ?></td>
                                <td style="width:65%"><?= h($category['description_'.__('lang')]) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Content') ?></td>
                                <td style="width:65%"><?= ($category['content_'.__('lang')]) ?></td>
                            </tr>
                            <tr>
                                <td style="width:35%;"><?= __('Active') ?></td>
                                <td style="width:65%"><?= $this->Core->active($category, 'active')?></td>
                            </tr>
                            </tbody>
                        </table>
                    </fieldset>
