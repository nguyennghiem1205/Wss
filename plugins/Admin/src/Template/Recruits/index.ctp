    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-editbutton="true">
            <header>
                ...
                <h2><?= __('list of recruitment news')?></h2>
            </header>
                ...
                <div class="widget-body no-padding">
                    ...
                    <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="hasinput">
                                <input type="text" class="form-control" placeholder="<?= __('filter') ?> <?= __('Number') ?>" />
                            </th>
                        ...
                        <?php foreach ($recruits as $row): ?>
                            <tr>
                                ...
                                <td><?= $row['content_'.__('lang')] ?></td>
                                <td><?= $row['position'] ?></td>
                                <td><?= $row['number'] ?></td>
                                <td><?= $this->Core->active($row, 'active')?></td>
                                <td>
                                    <?php echo $this->element('link_action', array('item' => $row, 'model'=> 'Sites')) ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
